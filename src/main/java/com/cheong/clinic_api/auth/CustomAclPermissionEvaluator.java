...
public class CustomAclPermissionEvaluator implements PermissionEvaluator  {
	...
	private SidRetrievalStrategy sidRetrievalStrategy = new CustomSidRetrievalStrategyImpl();
	...
	private boolean checkPermission(Authentication authentication, ObjectIdentity oid, Object permission) {
		...
		sids.forEach(e->System.out.println(e));
		
		List<Permission> requiredPermission = resolvePermission(permission);
		
		requiredPermission.forEach(e->System.out.println(e.getMask()));
